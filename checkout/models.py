...
class Order(models.Model):
    ...
    def update_total(self):
        """
        Update grand total each time a line item is added, removed, or updated
        """
...
class OrderLineItem(models.Model):
    ...
    lineitem_total = models.DecimalField(max_digits=10, decimal_places=2, null=False, editable=False)
